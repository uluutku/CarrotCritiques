          ...
          <CardContent>
            ...
            {restaurant.ratings && restaurant.ratings.length > 0 ? (
              <div>
                ...
                <Rating name={`rating-${restaurant.id}`} value={restaurant.ratings[restaurant.ratings.length - 1]} sx={{ marginTop: '10px'}} readOnly />
              </div>
            ) : <div><br></br> <Typography variant="h6">Davşan henüz burayı puanlamadı.</Typography></div>}
          </CardContent>
        </Card>
       </div>
      ))}
